		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Github Demo",
									"targetURL": "#demogithubdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demogithubdemo-display": {
								"semanticObject": "demogithubdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.githubdemo",
									"url": sap.ui.require.toUrl("demo/githubdemo")
								}
							}
						}
					}
